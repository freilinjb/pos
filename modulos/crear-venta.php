                                                ...
                                                <tr>
                                                    <td style="width: 50%;">
                                                        <div class="input-group">
                                                            <input type="number" class="form-control input-lg" name="nuevoImpuestoVenta" id="nuevoImpuestoVenta" placeholder="0" require>
                                                             <input type="hidden" name="nuevoPrecioImpuesto" id="nuevoPrecioImpuesto" require>
                                                             <input type="hidden" name="nuevoPrecioNeto" id="nuevoPrecioNeto" require>
                                                    ...
                                                    <td style="width: 50%;">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control input-lg" name="nuevoTotalVenta" total=""  id="nuevoTotalVenta" placeholder="00000" readonly require>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
